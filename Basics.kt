...
fun main()
{
    ...
    //Short way of if else statement
    nullableName?.let{  println(it.length) }

    //Elvis operator (?:)
    val name2 = nullableName ?: "Guest" //If nullableName is null then use Guest as default value, else use nullableName

    //Not nullable assertion - (!!) (It forcefully tells compiler that no null value is passed through the variable)
...
//Third Function with a return type
...
//A function returns values while procedure doesn't
